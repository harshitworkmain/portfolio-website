          ...
          <div className="lg:col-span-1 flex flex-col gap-10">
            ...
            <div>
              ...
              <div className="flex flex-col gap-6 pl-2 border-l border-zinc-200">
                <div>
                  <span className="block text-[10px] uppercase font-semibold text-zinc-400">2023 – 2027</span>
                  <span className="block text-xs font-bold text-black uppercase mt-1">B.Tech ECE (Undergrad)</span>
                  <span className="block text-[11px] text-zinc-500 mt-0.5">VIT Chennai (CGPA: 8.07)</span>
                </div>
                <div>
                  <span className="block text-[10px] uppercase font-semibold text-zinc-400">2022 – 2023</span>
                  <span className="block text-xs font-bold text-black uppercase mt-1">Class XII Secondary</span>
                  <span className="block text-[11px] text-zinc-500 mt-0.5">New Era School, Ghaziabad (87.2%)</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-2 flex flex-col gap-10">
            ...
            <div>
              ...
              <div className="flex flex-col gap-8">
                {/* STEMTEC */}
                <div className="glass-panel rounded-lg p-6 border border-zinc-100">
                  <div className="flex items-center justify-between flex-wrap gap-2 mb-3">
                    <div>
                      <h3 className="text-xs font-bold text-black uppercase">AI &amp; Robotics Intern</h3>
                      <span className="block text-[11px] text-zinc-400 mt-0.5 font-light">STEMTEC AI &amp; Robotics Tech | Chennai, IN</span>
                    </div>
                    <span className="px-2 py-0.5 rounded text-[8px] font-semibold tracking-widest bg-zinc-100 border border-zinc-200 text-zinc-500 uppercase">
                      Jul &apos;25 – Aug &apos;25
                    </span>
                  </div>
                  <ul className="text-xs text-zinc-500 font-light leading-relaxed flex flex-col gap-2 list-disc pl-4">
                  ...
                  <div className="mt-4 pt-4 border-t border-zinc-100">
                    <a
                      ...
                      className="inline-flex items-center gap-1.5 text-[9px] uppercase tracking-widest font-semibold text-zinc-400 hover:text-black transition-colors duration-300"
                    >
                ...
                <div className="glass-panel rounded-lg p-6 border border-zinc-100">
                  <div className="flex items-center justify-between flex-wrap gap-2 mb-3">
                    <div>
                      ...
                      <span className="block text-[11px] text-zinc-400 mt-0.5 font-light">Team Namo Nirvana (Special Robotics Unit)</span>
                    </div>
                    <span className="px-2 py-0.5 rounded text-[8px] font-semibold tracking-widest bg-zinc-100 border border-zinc-200 text-zinc-500 uppercase">
                      Jan &apos;25 – Present
                    </span>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {/* SIH */}
                <div className="glass-panel p-5 rounded-lg border border-zinc-100 flex flex-col justify-between">
                  <div>
                    <span className="block text-[9px] font-semibold uppercase text-zinc-400">Qualifiers</span>
                    <h4 className="text-xs font-bold text-black uppercase mt-1 leading-tight">SIH&apos;25 National Finalist</h4>
                    <p className="text-[11px] text-zinc-500 font-light mt-2 leading-relaxed">
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-1 text-[9px] uppercase tracking-widest font-semibold text-zinc-400 hover:text-black transition-colors duration-300 mt-4"
                  >
                    SIH Certificate
                  </a>
                </div>
                ...
                <div className="glass-panel p-5 rounded-lg border border-zinc-100 flex flex-col justify-between">
                  <div>
                    <span className="block text-[9px] font-semibold uppercase text-zinc-400">3rd Place</span>
                ...
                {/* V-NEST */}
                <div className="glass-panel p-5 rounded-lg border border-zinc-100">
                  <span className="block text-[9px] font-semibold uppercase text-zinc-400">1st Place</span>
                ...
                {/* NCC */}
                <div className="glass-panel p-5 rounded-lg border border-zinc-100">
                  <span className="block text-[9px] font-semibold uppercase text-zinc-400">Corporal</span>
